window.onload = function () {
    ...
    menu_dat.onclick = function () {
        snd_datalocal.play();
        changeSection(this, 'data.php', 'js/data.js');
    };
    ...
    menu_dic.onclick = function () {
        snd_dicas.play();
        changeSection(this, 'dicas.php', 'js/dicas.js');
    };
    ...
    menu_con.onclick = function () {
        snd_confirm.play();
        changeSection(this, 'confirm.php', 'js/confirm.js');
    };
    ...
    menu_liv.onclick = function () {
        snd_livro.play();
        changeSection(this, 'livro.php', 'js/livro-min.js');
    };
